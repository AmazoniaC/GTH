...
export class PayrollController {
  ...
  sendPeriodPayslips = async (req: Request, res: Response) => {
    const data = await payrollService.sendPeriodPayslips(req.params.id, req.auth!.organizationId);
    return ok(res, data);
  };

  pilaForPeriod = async (req: Request, res: Response) => {
    const data = await payrollService.pilaForPeriod(req.params.id, req.auth!.organizationId);
    return ok(res, data);
  };
